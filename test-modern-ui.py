...
class TransactionUI:
    ...
    def create_widgets(self):
        ...
        for widget in [self.transaction_combo, self.log_memory, self.log_disk, self.message_display, self.protocol_combo]:
            widget.configure(bg=self.secondary_color, fg=self.text_color)
